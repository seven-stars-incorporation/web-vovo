<?php
  ...
  $infos = 'https://chart.googleapis.com/chart?chs=256x256&cht=qr&chl=http://192.168.0.101:8080/web-vovo/src/views/index.php';
  ...
  if (isset($_COOKIE["recipes_favs"]) || isset($_COOKIE["categories_favs"])){
    ...
    $infos = "https://chart.googleapis.com/chart?chs=256x256&cht=qr&chl=http://192.168.0.101:8080/web-vovo/src/views/index.php?recipes={$_COOKIE["recipes_favs"]}";
  }
?>
      ...
      <div class="mt-6 bg-white rounded-xl shadow-lg py-8">
        <div class="flex items-center justify-center gap-16">
          ...
          <div class="border border-zinc-300 rounded-md">
            <img src=<?php echo ($infos); ?>&choe=UTF-8 title="Leia o QR Code" class="rounded-md"/>
          </div>
        </div>
      </div>
    </div>
